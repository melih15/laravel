  ...
  <body>
    ...
    <div class="container" style="margin-top:50px;">
        ...
        <div class="mb-3">
            ...
            <input type="Voornaam" class="form-control" id="exampleFormControlInput1" placeholder="name">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Achternaam</label>
            <input type="name" class="form-control" id="exampleFormControlInput1" placeholder="Achternaam">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Telefoon</label>
            <input type="name" class="form-control" id="exampleFormControlInput1" placeholder="+31 612345678">
        </div>
        <div class="mb-3">
